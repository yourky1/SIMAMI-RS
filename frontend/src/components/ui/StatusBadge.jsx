...
export default function StatusBadge({ value }) {
  const styles = {
    ...
    Nonaktif: "bg-slate-50 text-slate-700 ring-slate-200",
    "Menunggu Persetujuan": "bg-amber-50 text-amber-700 ring-amber-200",
    Disetujui: "bg-blue-50 text-blue-700 ring-blue-200",
  ...
  return (
    <span className={cn("inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-black ring-1 shadow-sm", styles[value] || "bg-slate-50 text-slate-700 ring-slate-200")}>
